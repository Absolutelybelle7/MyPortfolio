...
import { Sun, Moon, Github, Linkedin, Mail,Menu, X, Phone } from 'lucide-react';
...
function App() {
  ...
  const projects: Project[] = [
    {
      ...
      image: ecommerce,
      description: 'A modern e-commerce solution built with Typscript and Node.js'
    },
    {
      title: 'Construction Platform',
      image: construction,
      description: 'a construction company showcasing services, projects, and contact information.'
    },
    {
      title: 'Dessert Shop',
      image: dessert,
      description: 'A website for a dessert shop with a menu, gallery, and contact form.'
    },
    {
      title: 'Tattoo Studio',
      image: tattoo,
      description: 'A bold and stylish tattoo studio website with a stunning gallery, featured artists, and a hassle-free contact form'
    },
    {
      title: 'Restaurant',
      image: restaurant,
      description: 'A stylish restaurant website featuring a menu, chef highlights, reviews, and easy reservations.'
    },
    {
      title: 'Building Company',
      image: building,
      description: 'A building company website with a portfolio, services, and contact form.'
    },
  ];

  return (
    <div className={`min-h-screen transition-colors duration-500 ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-white'}`}>
      {/* Navigation */}
      <nav className="fixed w-full z-20 backdrop-blur-sm bg-white/75 dark:bg-gray-900/75 shadow-md">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        {/* Logo */}
        <div className="text-2xl text-blue-400 font-bold animate-slide-in">Belle Creatives</div>
        ...
        <div className="container mx-auto px-6 h-screen flex items-center">
          ...
          <div className="animate-fade-in max-w-xl">
            ...
            <p className="text-white dark:text-white mb-8 max-w-lg">
              Building beautiful and functional web experiences with a focus on user interaction and modern technologies.
            </p>
            <button 
  ...
  onClick={() => window.open("https://forms.gle/C38d4sNM7hs543Yn9", "_blank")}
>
  Get In Touch
</button>
          ...
          <div className="hidden md:block absolute right-0 top-1/2 transform -translate-y-1/2">
            <div className="w-[600px] h-[600px] relative z-10 animate-float-slow">
              <img
                src={Logo}
                alt="Profile"
  ...
  <div className="container mx-auto max-w-4xl animate-fade-in">
    ...
    <p className="text-lg sm:text-xl text-white dark:text-black text-center leading-relaxed">
      I'm a passionate web developer crafting sleek, functional, <br className="hidden sm:inline" />
      and user-friendly websites that bring ideas to life. With 3 years of experience in web development, <br className="hidden md:inline" />
      I specialize in React, TypeScript, Node.js, and modern web technologies. <br />
      Beyond coding, I love exploring open-source projects and sharing my knowledge.
    </p>
  </div>
</section>
      ...
      {/* Skills Section */}
      <section id="skills" className="py-20 px-6 bg-gray-50 bg-gradient-to-br from-rose-100 via-white to-blue-100 dark:from-rose-900 dark:via-gray-900 dark:to-blue-900">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl font-bold text-center mb-12 animate-fade-in">My Skills</h2>
      ...
      <section id="contact" className="py-20 px-6 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto max-w-4xl">
          <h2 className="text-3xl font-bold text-center mb-12 animate-fade-in">Contact Me</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 stagger-children">
            <div className="flex items-center gap-4 justify-center">
              <Mail className="text-rose-500 animate-bounce" size={24} />
              <a href="mailto:adansibonnahc@gmail.com" className="hover:text-rose-500 transition-colors hover:scale-105 transform">
                adansibonnahc@gmail.com
              </a>
            </div>
            <div className="flex items-center gap-4 justify-center">
              <Phone className="text-rose-500 animate-bounce" size={24} />
              <a href="tel:+233530121155" className="hover:text-rose-500 transition-colors hover:scale-105 transform">
                +233 530 121 1155
              </a>
            </div>
            <div className="flex items-center gap-4 justify-center">
